 ...
 *
 */
public class ShowListComputerActivity extends Activity{
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                ShowListComputerActivity.this.finish();
            }
        });
    }
    ...
    public void updateUI()
    {
        ...
        if(database!=null)
        {
            ...
            header.setField2("Mã hãng");
            header.setField3("Tên hãng");
            list.add(header);
            cursor.moveToFirst();
...
//            cursor.close();
            adapter=new MySimpleArrayAdapter(ShowListComputerActivity.this, R.layout.my_layout_for_show_list_data, list);
            ...
            lv.setOnItemClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> arg0, View arg1,
                                        int arg2, long arg3) {
                    // TODO Auto-generated method stub
                    Toast.makeText(ShowListComputerActivity.this,"View -->"+ list.get(arg2).toString(), Toast.LENGTH_LONG).show();
                    Intent intent=new Intent(ShowListComputerActivity.this, CreateLabelActivity.class);
            ...
            lv.setOnItemLongClickListener(new OnItemLongClickListener() {
                ...
                public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
                    ...
                    final int pos=arg2;
                    Toast.makeText(ShowListComputerActivity.this, "Edit-->"+data.toString(), Toast.LENGTH_LONG).show();
                    AlertDialog.Builder b=new Builder(ShowListComputerActivity.this);
                    b.setTitle("Remove");
                    ...
                    b.setPositiveButton("Có", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            if(n>0)
                            {
                                Toast.makeText(ShowListComputerActivity.this, "Remove ok", Toast.LENGTH_LONG).show();
                                list.remove(pos);
                                adapter.notifyDataSetChanged();
                            }
                            else
                            {
                                Toast.makeText(ShowListComputerActivity.this, "Remove not ok", Toast.LENGTH_LONG).show();
                            }
                        }
                    });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(resultCode==MainActivity.SEND_DATA_FROM_AUTHOR_ACTIVITY)
        {
            ...
            if(database!=null)
            {
                ...
                if(n>0)
                {
                    Toast.makeText(ShowListComputerActivity.this, "update ok ok ok ", Toast.LENGTH_LONG).show();
